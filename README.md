...
- **Roots:** 北海道 帯広出身。
- **Passions:** サウナ ♨️ / AI 活用 🤖 / ライフログの構築
- **Vision:** AI を活用したビジネスを構築すること。
...
| 073 | 03/14 | Daily Planner                | Next.js / Codex CLI / Task Drag-and-Drop                            | [View](./hono-next/src/app/day073)                                        |
...
| 082 | 03/23 | Rails 画像リサイズ           | Rails MiniMagick / 切り抜き / Active Storage                        | [View](./rails8)                                                          |
...
| 091 | 04/01 | Rails Ruby Editor            | Rubyを簡単に実行 / Railsで動作                                      | [View](./rails8)                                                          |
| 092 | 04/02 | Rails Othelo                 | アニメーションなしオセロ / Stimulus                                 | [View](./rails8)                                                          |
| 093 | 04/03 | Rails 購入トラッカー         | Turbo Frame / 次回購入日を計算                                      | [View](./rails8)                                                          |
| 094 | 04/04 | Rails CSV インポート         | RailsでCSV解析 / 100万件でも一瞬でフィルタ                          | [View](./rails8)                                                          |
| 095 | 04/05 | Rails CSV インポート ver2    | 複数CSV解析 / カード明細を1年分取り込んでSQL検索                    | [View](./rails8)                                                          |
| 096 | 04/06 | Rails Three ER               | Railsのschemaをとり込み / Three.jsでリレーションを表示              | [View](./rails8)                                                          |
| 097 | 04/07 | Rails 予約管理アプリ         | Resend で予約完了メール / カレンダーで空き日表示                    | [View](./rails8)                                                          |
| 098 | 04/08 | Rails WebPush                | 管理者がメッセージを送付すると、iPhoneで通知表示                    | [View](./rails8)                                                          |
| 099 | 04/09 | Rails CVE notifier           | Rails で hackernews を RSS パース / gemini api を使用し日本語で要約 | [View](./rails8)                                                          |
| 100 | 04/10 | プログラミング言語の歴史     | 【Day 100/100】プログラミング言語の歴史                             | [View](./rails8)                                                          |

## 🆕 Latest Post

- **Day 100:** プログラミング言語の歴史
- **Date:** 2026-04-10
- **Summary:** 【Day 100/100】プログラミング言語の歴史
- **Features:**
- **Post:** https://x.com/ruu_web/status/2042573607092785269
