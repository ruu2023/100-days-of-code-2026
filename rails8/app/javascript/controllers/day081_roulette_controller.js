...
export default class extends Controller {
  ...
  resetMode() {
    ...
    this.resultMetaTarget.textContent =
      "抽選すると、ここに結果が表示されます。";
    this.persistAndRender();
  }
  ...
  renderWheel() {
    ...
    if (items.length === 0) {
      ...
      this.wheelTarget.style.background =
  ...
  renderLists() {
    this.activeListTarget.innerHTML = this.renderItems(
      this.activeItems(),
      false,
    );
