...
import { Trash2, CheckCircle, Youtube } from 'lucide-react';
...
export default function LyricApp() {
  ...
  return (
    <div className="min-h-screen bg-[#030003] text-zinc-100 p-4 md:p-10 font-sans selection:bg-red-500/30">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-10">
          ...
          <div className="space-y-6">
            ...
            {selected && (
              <div className="p-5 bg-red-600/10 border border-red-600/20 rounded-3xl flex items-center gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {songs.map(song => (
            <div key={song.id} className="bg-zinc-900 rounded-[2.5rem] p-6 border border-zinc-800 hover:border-red-600/50 transition-all group relative">
              ...
              <div className="h-48 overflow-y-auto text-sm text-zinc-400 italic leading-relaxed whitespace-pre-wrap border-t border-zinc-800 pt-4">
                {song.lyrics}
              </div>
