  ...
  return (
    <div className="min-h-screen p-8 pb-20 sm:p-20 font-sans">
      <main className="max-w-2xl mx-auto flex flex-col gap-8">
        ...
        <div className="bg-white/5 p-6 rounded-2xl border border-gray-200 shadow-xl">
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              {!result ? (
                ...
                >
                  ...
                  <button
                    onClick={fetchQuestion}
                    className="mt-4 px-4 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition w-full"
                  >
                    次の問題へ →
                  </button>
                </div>
