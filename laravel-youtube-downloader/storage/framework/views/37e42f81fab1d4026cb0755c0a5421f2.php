                    ...
                    <ul class="space-y-2">
                        <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-center justify-between bg-gray-700 rounded px-4 py-2">
                                <span class="truncate"><?php echo e($file['name']); ?></span>
                                <span class="text-sm text-gray-400"><?php echo e(round($file['size'] / 1024 / 1024, 2)); ?> MB</span>
                            </li>
...
</html><?php /**PATH /var/www/html/resources/views/youtube/index.blade.php ENDPATH**/ ?>