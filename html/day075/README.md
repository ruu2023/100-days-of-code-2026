...
- `localhost` / `127.0.0.1` / `::1` で開いた場合: `http://localhost:8787/api/day075/search`
- それ以外で開いた場合: `https://ruu-dev.com/api/day075/search`

GitHub Pages に配置する場合の想定 URL:

- `https://ruu2023.github.io/100-days-of-code-2026/html/day075/`
