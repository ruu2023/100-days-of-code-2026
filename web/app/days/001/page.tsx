...
const fortunes: Fortune[] = [
  { label: "大吉", message: "最初のデプロイに成功したよ! 🚀", color: "text-green-500" },
  { label: "中吉", message: "StackOverFlowで完璧な回答を見つけられた. ✨", color: "text-blue-500" },
  { label: "小吉", message: "ビルドは通った、けどテストに通らない. 🤔", color: "text-yellow-500" },
  { label: "末吉", message: "簡単にコンフリクトを解消", color: "text-orange-500" },
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 text-gray-900 p-4 font-sans">
      <div className="text-center max-w-md w-full">
        ...
        <p className="text-gray-500 mb-8">本日のおみくじ for 100-day challenge.</p>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 min-h-[200px] flex flex-col items-center justify-center transition-all duration-300">
          {fortune ? (
            <div className="animate-in fade-in zoom-in duration-300">
              <h2 className={`text-3xl font-bold mb-4 ${fortune.color}`}>{fortune.label}</h2>
